...
${bold}${lightblue}         KOLAMA.HOST DEBIAN VM
${bold}${lightblue}         KOLAMA.HOST VM INSTALLER
...
if [[ -f "./installed" ]]; then
    echo "${bold}${lightgreen}==> Started ${lightblue}VM${lightgreen} <=="
    function runcmd1 {
...
${bold}${lightblue}         KOLAMA.HOST DEBIAN VM
${bold}${lightblue}         KOLAMA.HOST VM STARTING
